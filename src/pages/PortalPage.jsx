...
function PortalPage() {
    ...
    const handleRegister = async (event) => {
        ...
        try {
            ...
            if (response.status === 201) {
                ...
                setRegEmail('');
                setRegSenha('');
                // Não precisa de setActiveTab se não houver abas
            } else {
    ...
    // Note: Funções de Reset de Senha foram omitidas para focar no design de duas colunas que você enviou.
    ...
    return (
        ...
        >
            ...
            {/* CORREÇÃO DO LAYOUT: ESTRUTURA DE DUAS COLUNAS FIXAS */}
